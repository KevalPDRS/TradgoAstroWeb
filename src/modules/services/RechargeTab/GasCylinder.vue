      ...
      <div
        ...
        <div class="flex-auto">
          <div class="flex flex-col gap-1">
            <label for="selectOperator">Select Your Operator</label>
            <Dropdown
            ...
            <small id="selectOperator-error" classs="text-danger hidden"
        ...
        <div class="flex-auto">
          <div class="flex flex-col gap-1">
            <label for="contactNumber">Registered Contact Number</label>
            <InputNumber
            ...
            <small id="contactNumber-error" classs="text-danger hidden"
...
<script setup>
  ...
  const contactNumberValue = ref(null);
